    ...
    <div class="flex-row">
      <div class="source">
        ...
        <div class="button-container">
          ...
          <button type="button" @click.prevent="VueCanvasDrawing.undo()">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <button type="button" @click.prevent="VueCanvasDrawing.redo()">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <button type="button" @click.prevent="VueCanvasDrawing.reset()">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
...
const setWatermarkImage = async (event: any) => {
  let URL = window.URL
  watermark.value = {
    type: 'Image',
